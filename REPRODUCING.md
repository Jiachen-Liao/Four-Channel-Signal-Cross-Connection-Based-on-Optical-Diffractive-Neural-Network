...
`registry.codeocean.com/published/3112bff2-b5ac-42f6-bd6d-e23abb37e83b:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/3112bff2-b5ac-42f6-bd6d-e23abb37e83b:v1 bash run
```
